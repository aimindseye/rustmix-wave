...
DEST="$VOLUME/RUSTMIX"
mkdir -p "$DEST/SLEEP" "$DEST/BOOKS" "$DEST/READER/CACHE" "$DEST/FONTS" "$DEST/APPS/HGRID" "$DEST/APPS/SUDOKU" "$DEST/APPS/MINES" "$DEST/APPS/TILTMAZE" "$DEST/APPS/M2048" "$DEST/APPS/SOKOBAN" "$DEST/APPS/DICT/DATA" "$DEST/APPS/CALENDAR"
...
copy_example "$SRC/FONTS/README.TXT" "$DEST/FONTS/README.TXT"
